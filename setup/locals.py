...
def start():
    ...
    print(f"{a}\n\n")
    print("Welcome to RepthonAr, lets start setting up!\n\n")
    print("Cloning the repository...\n\n")
    os.system("rm -rf RepthonAr")
    os.system("git clone https://github.com/rogerpq/RepthonAr")
    print("\n\nDone")
    os.chdir("RepthonAr")
    clear_screen()
    print(a)
...
def gen_session():
    ...
    os.system("python3 razan/session/ssgen.py")
